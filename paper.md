...
I've been reading the design notes from C#, D, Rust, and Swift design communities. Most of the focus is on how blocks of code are decorated to highlight unsafety. The unsafe spotlight is important but doesn't deliver confidence where you need it most, the transition from unsafe to safe code. That's a word for that: "trust boundary". Our threat-modeling training emphasizes focus on that boundary. This transition point should be the most lit up, attracting the most scrutiny. At the end of the day, it's only the boundary and what holds it up that matters. On the face of it, it seems like there is a bridge missing between our threat modeling and langugage design instincts. We're in the middle of designing C# memory safety v2. It's the moment to resolve this gap.
